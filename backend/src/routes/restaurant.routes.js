...
// All restaurant routes require authentication and restaurant_owner role
router.use(auth_1.authenticateToken);
router.use((0, auth_1.authorize)('restaurant_owner'));
// Menu Management
router.post('/menu', restaurantController.addMenuItem);
router.get('/menu', restaurantController.getMenuItems);
router.put('/menu/:id', upload_1.upload.single('image'), restaurantController.updateMenuItem);
// Orders
...
router.put('/profile', upload_1.upload.single('image'), restaurantController.updateRestaurantProfile);
