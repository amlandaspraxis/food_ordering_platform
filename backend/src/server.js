...
app.use((0, cors_1.default)({
    origin: process.env.FRONTEND_URL || 'https://food-ordering-platform-xi.vercel.app/',
    credentials: true,
}));
...
// MongoDB Connection
mongoose_1.default.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/food_delivery')
